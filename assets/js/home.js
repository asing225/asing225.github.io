...
function openText(){
    var hd = KUTE.to(h2, {text: 'Hello World!'}, {delay: 4500, duration:2000, easing: 'easingCubicInOut'}).start(),
	    ld = KUTE.to(lead, {text: '{<br>"name" : "Amanjot Singh",<br>"university" : "Arizona State University",' +
				'<br>"program" : "Masters in Software Engineering"<br>}'}, {duration:4000, easing: 'easingCubicInOut'}),
